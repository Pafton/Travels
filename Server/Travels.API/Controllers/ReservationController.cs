...
namespace Travels.API.Controllers
{
    ...
    public class ReservationController : ControllerBase
    {
        ...
        [SwaggerOperation(Summary = "Pobiera rezerwację o podanym ID -- CUSTOMER", Description = "Zwraca szczegóły rezerwacji na podstawie identyfikatora.")]
        ...
        [SwaggerOperation(Summary = "Anuluje rezerwację o podanym ID -- CUSTOMER", Description = "Anuluje rezerwację na podstawie identyfikatora.")]
        ...
        [SwaggerOperation(Summary = "Aktualizuje rezerwację o podanym ID -- CUSTOMER", Description = "Aktualizuje rezerwację na podstawie identyfikatora i przekazanych danych.")]
